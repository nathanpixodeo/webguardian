...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="https://github.com/nathanpixodeo/web-guardian" target="_blank" class="text-slate-400 hover:text-slate-600 transition-colors">
    ...
    <footer class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-8 border-t border-slate-200">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-400">
            ...
            <div class="flex items-center gap-4">
                <a href="https://github.com/nathanpixodeo/web-guardian" class="hover:text-slate-600 transition-colors">GitHub</a>
